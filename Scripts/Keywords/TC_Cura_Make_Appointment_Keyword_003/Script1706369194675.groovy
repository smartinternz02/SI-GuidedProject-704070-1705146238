...
CustomKeywords.'com.qa.test.customFunctions.CheckDropDownListElementExist'(findTestObject('Cura_pages_OR/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Tokyo CURA Healthcare Center')

WebUI.click(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/input_hospital_readmission'))

WebUI.click(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/input_programs'))

WebUI.click(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/span_glyphicon glyphicon-calendar'))

WebUI.click(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/td_15'))

WebUI.setText(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/textarea_comment'), 'Emergency')

WebUI.click(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Cura_pages_OR/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 
    0)
